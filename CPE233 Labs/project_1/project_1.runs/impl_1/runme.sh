...
HD_PWD='C:/CPE233/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fibonacci_seq_gen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fibonacci_seq_gen.tcl -notrace
